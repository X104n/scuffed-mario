...
public class GameScreen implements Screen {
    ...
    public GameScreen(final ScuffedMario game) {
        ...
        // Note that we make the camera a fixed size here
        // so if we want to show more at a time we need to upscale it here
    ...
    public void render(float v) {
        ...
        //drawing the hud (will be updated along with the rest of the code)
        hud.stage.draw();
